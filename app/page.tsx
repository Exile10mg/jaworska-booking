        ...
        <section className="flex-1 flex flex-col overflow-visible px-4 pb-4 pt-0 md:px-5 lg:overflow-hidden lg:px-6 lg:pb-4 lg:pt-0">
          ...
          {step === 1 && (
            ...
            >
                  ...
                  <div
                    className={cn(
                      ...
                      shouldScrollServices &&
                        "app-scrollbar service-list-scroll lg:overflow-y-auto lg:pr-3 lg:pb-6",
                    )}
                  >
              ...
              <div className="sticky bottom-0 z-20 mt-auto -mx-1 shrink-0 bg-[#fcfaf8]/95 px-1 pb-1 pt-3 backdrop-blur supports-[backdrop-filter]:bg-[#fcfaf8]/80 md:static md:mx-0 md:bg-transparent md:px-0 md:pb-0 md:pt-5">
                <button
                  type="button"
            ...
            <div className="animate-step-enter flex h-full flex-col">
              ...
              <div className="mt-auto flex gap-3 pt-4 md:pt-5 lg:mb-1">
                ...
                <button
                  ...
                  className={bottomPrimaryButtonClass}
                >
                  <span>{isSubmitting ? "Zapisywanie..." : "Potwierdź rezerwację"}</span>
                  {!isSubmitting && (
                    <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/75 text-white">
